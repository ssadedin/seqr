...
class SequencingSample(models.Model):
    ...
    #SAMPLE_ALIAS = models.CharField(null=True, blank=True)   # from picard .variant_calling_detail_metrics
    HET_HOMVAR_RATIO  = models.FloatField(null=True, blank=True)
    TOTAL_SNPS = models.IntegerField(null=True, blank=True)
    NUM_IN_DB_SNP = models.IntegerField(null=True, blank=True)
    NOVEL_SNPS = models.IntegerField(null=True, blank=True)
    FILTERED_SNPS = models.IntegerField(null=True, blank=True)
    PCT_DBSNP = models.FloatField(null=True, blank=True)
    DBSNP_TITV = models.FloatField(null=True, blank=True)
    NOVEL_TITV = models.FloatField(null=True, blank=True)
    TOTAL_INDELS = models.IntegerField(null=True, blank=True)
    NOVEL_INDELS = models.IntegerField(null=True, blank=True)
    FILTERED_INDELS = models.IntegerField(null=True, blank=True)
    PCT_DBSNP_INDELS = models.FloatField(null=True, blank=True)
    NUM_IN_DB_SNP_INDELS = models.IntegerField(null=True, blank=True)
    DBSNP_INS_DEL_RATIO = models.FloatField(null=True, blank=True)
    NOVEL_INS_DEL_RATIO = models.FloatField(null=True, blank=True)
    TOTAL_MULTIALLELIC_SNPS = models.IntegerField(null=True, blank=True)
    NUM_IN_DB_SNP_MULTIALLELIC = models.IntegerField(null=True, blank=True)
    TOTAL_COMPLEX_INDELS = models.IntegerField(null=True, blank=True)
    NUM_IN_DB_SNP_COMPLEX_INDELS = models.IntegerField(null=True, blank=True)
    SNP_REFERENCE_BIAS = models.FloatField(null=True, blank=True)
    NUM_SINGLETONS = models.IntegerField(null=True, blank=True)

    PCT_CHIMERAS = models.FloatField(null=True, blank=True) # from picard .alignment_summary_metrics
    FREEMIX = models.FloatField(null=True, blank=True)      # from picard .selfSM  - contamination estimate generated by verifyBAMID

    GQ0_FRACTION = models.FloatField(null=True, blank=True)
    PCT_TARGET_BASES_20X = models.FloatField(null=True, blank=True)     # from picard .hybrid_selection_metrics`
